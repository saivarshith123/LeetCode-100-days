import java.util.*;
// Question Name: Total Characters in String After Transformations II
public class day32_0{
    private static final int K = 26;
    private static final int MOD = 1_000_000_007;
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.print("Enter string s (lowercase letters): ");
        String s = sc.nextLine();
        System.out.print("Enter number of transformations t: ");
        int t = sc.nextInt();
        List<Integer> nums = new ArrayList<>();
        System.out.println("Enter 26 integers (space-separated) for each letter a-z:");
        for (int i = 0; i < 26; i++) {
            nums.add(sc.nextInt());
        }
        int result = lengthAfterTransformations(s, t, nums);
        System.out.println("Resulting string length after transformations: " + result);
        sc.close();
    }
    ...
    private static long[][] matrixPower(long[][] M, int exp) {
